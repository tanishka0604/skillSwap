...
/** Handles POST /requests/accept. Expects a "requestId" form field. */
@WebServlet("/requests/accept")
public class AcceptRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.getWriter().write(JsonUtil.successMessage("Request accepted."));
