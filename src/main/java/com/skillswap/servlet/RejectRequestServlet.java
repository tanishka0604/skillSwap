...
/** Handles POST /requests/reject. Expects a "requestId" form field. */
@WebServlet("/requests/reject")
public class RejectRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.getWriter().write(JsonUtil.successMessage("Request rejected."));
