...
/**
 * Handles POST /skills/add. Expects form fields: name, category, type
 * (type is "TEACH" or "LEARN", matching the SkillType enum).
 */
@WebServlet("/skills/add")
public class AddSkillServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Skill skill = skillService.addSkill(userId, name, category, type);
            response.setStatus(HttpServletResponse.SC_OK);
            response.getWriter().write(JsonUtil.successMessage(skill.getName() + " added."));
